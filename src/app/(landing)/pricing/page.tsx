      ...
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-base/7 text-gray-600 max-w-prose text-center text-pretty">
            ...
            offer lifetime access for a one-time payment
          </p>
        </div>
        <div className="bg-white mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <ul className="mt-8 grid-cols-1 gap-4 text-sm/6 text-gray-600 sm:grid-cols-2 sm:gap-6">
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900 lg:flex lg:flex-col lg:justify-center lg:py-16">
